...
First, setup the directory by unzipping the output of pathway reconstruction and 

```
unzip data.zip #Unzip bundled data
mkdir axRuns #Create a directory for hyperparameter tuning
```
