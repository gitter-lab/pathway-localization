...
if __name__ == "__main__":
    ...
    parameters=[
        {"name": "lRate", "type": "range", "bounds": [1e-3, 0.01], "log_scale": True},
        {"name": "l_depth", "type": "range", "value_type": "int", "bounds": [1, 5]},
        {"name": "dropout", "type": "choice", "value_type": "float", "values": [0.0, 0.5]},
        #{"name": "trainedNets", "type": "choice", "value_type": "str", "values": ["allReactomePaths","allPathBank"]},
        ...
        {"name": "outputFile", "type": "fixed", "value_type": "str", "value": outF},
