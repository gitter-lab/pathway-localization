...
using namespace DirectGraphicalModels;
    ...
    void makeAndInferGraph(std::string gFil, std::string comPPIFile, std::shared_ptr<CTrainNode> &nodeTrainerProt, std::shared_ptr<CTrainNode> &nodeTrainerInter, std::shared_ptr<CTrainEdge> &edgeTrainer);
	void Main(void);
    ...
    void trainAndTestGraphs(std::string trainFile, std::string testFile, std::string comPPIFile);
    void makeGraphFromFile(std::string fName, CGraphPairwise &graph, std::shared_ptr<CTrainNode> *nodeTrainerProt, std::shared_ptr<CTrainNode> *nodeTrainerInter, std::shared_ptr<CTrainEdge> *edgeTrainer);
/// @endcond
